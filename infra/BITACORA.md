...
| 20/04/2026 | **CI/CD**: Refactorización de pipelines | Soporte de despliegue de Frontend con Nginx fix. |
| 20/04/2026 | **Deploy ARM** | Actualización exitosa del stack en Raspberry Pi. |
| 20/04/2026 | **Docs**: Mejora del README | Guía de comandos para PowerShell/Windows añadida. |
